...
let cases =
  "name parser service", [
    Alcotest.test_case "sanitise basic filename" `Quick test_sanitise_basic_filename;
    Alcotest.test_case "sanitise with year" `Quick test_sanitise_with_year;
    Alcotest.test_case "sanitise with quality" `Quick test_sanitise_with_quality;
    Alcotest.test_case "sanitise with codec" `Quick test_sanitise_with_codec;
    Alcotest.test_case "sanitise with release group" `Quick test_sanitise_with_release_group;
    Alcotest.test_case "sanitise complex filename" `Quick test_sanitise_complex_filename;
    Alcotest.test_case "sanitise no extension" `Quick test_sanitise_no_extension;
    Alcotest.test_case "sanitise multiple years" `Quick test_sanitise_multiple_years;
    Alcotest.test_case "sanitise no year" `Quick test_sanitise_no_year;
    Alcotest.test_case "sanitise old year" `Quick test_sanitise_old_year;
    Alcotest.test_case "sanitise future year" `Quick test_sanitise_future_year;
    Alcotest.test_case "sanitise special characters" `Quick test_sanitise_special_characters;
    Alcotest.test_case "sanitise empty filename" `Quick test_sanitise_empty_filename;
    Alcotest.test_case "sanitise only extension" `Quick test_sanitise_only_extension;
  ]