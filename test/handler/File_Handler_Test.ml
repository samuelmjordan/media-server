...
let cases =
  "file handler", [
    db_test_case "get directory missing path" `Quick test_get_directory_missing_path;
    db_test_case "get directory with path" `Quick test_get_directory_with_path;
    db_test_case "scan directory missing path" `Quick test_scan_directory_missing_path;
